...
So I have written one myself: [https://github.com/arkhebuz/primewatch](https://github.com/arkhebuz/primewatch). This is fork for Datacooin mining, as both coins are miner-compatibile. Not a cutting edge programming but address three things:
...
* **Edit** datawatch.sh file, all this is commented in code. You need to:
  ...
  5. Edit primeminer launch parameters. This script is written with [dtc.xpoll.xram.co](dtc.xpoll.xram.co) and [dtc.gpoool.net](dtc.gpoool.net) pools in mind, see my comments in code and check their sites;
