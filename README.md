...
* **Edit** datawatch.sh file, all this is commented in code. You need to:
  ...
  5. Edit primeminer launch parameters. This script is written with [http://www.dtc.xpoll.xram.co](http://www.dtc.xpoll.xram.co) and [http://www.dtc.gpoool.net](http://www.dtc.gpoool.net) pools in mind, see my comments in code and check their sites;
